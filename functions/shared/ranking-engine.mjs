...
function getProductSignals(raw = {}) {
  ...
  return {
    ...
    productHuntResearchStatus: String(rootSignals.productHuntResearchStatus || "").trim(),
  };
}
  ...
  return (devDocs || []).map((doc) => {
    ...
    const mergedProductSignals = getProductSignals({
      ...
      productSignals: {
        ...
        productHuntResearchStatus: metrics.productHuntResearchStatus || derivedProductSignals.productHuntResearchStatus || "",
      },
    });
  ...
  return {
    ...
    metricDocs: directory.map((record) => ({
      ...
      data: {
        ...
        productHuntResearchStatus: record.productSignals.productHuntResearchStatus,
